...
//import com.studypulse.feat.attendance.courses.domain.model.CourseSummaryDto
...
//            )
//            coEvery { courseSummaryRepository.getFlow("c1") } returns flowOf(courseSummary1)
//            coEvery { courseSummaryRepository.getFlow("c2") } returns flowOf(courseSummary2)
//
//            useCase.invoke().test {
